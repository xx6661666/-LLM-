...
# 文件路径设置
INPUT_PATH = '/Users/alan/科研/Rumor_Detection_Analysis/multimodal_fusion/devset_expanded_posts.json'
OUTPUT_DIR = '/Users/alan/科研/Rumor_Detection_Analysis/multimodal_fusion/devset_lda_results'
NUM_TOPICS = 7
